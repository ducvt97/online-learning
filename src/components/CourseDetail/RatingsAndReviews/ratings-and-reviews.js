...
const RatingsAndReviews = (props) => {
    ...
    return <View style={[styles.container, props.style]}>
        {props.state.userBuyCourse ? <View style={{marginBottom: 20}}>
            <Text style={[theme ? theme.textColor : {}, CommonStyles.fontSizeBig, CommonStyles.fontWeightBold]}>Your Review</Text>
            {props.state.userRatingCourse ? !isEditReview ?
                <View>
                    ...
                    <Button title="Edit Review" containerStyle={styles.button} loading={reviewLoading} onPress={onPressEditReview} />
                </View>
                : <View>
        ...
        <Text style={[theme ? theme.textColor : {}, CommonStyles.fontSizeBig, CommonStyles.fontWeightBold]}>Rating &amp; Reviews</Text>
